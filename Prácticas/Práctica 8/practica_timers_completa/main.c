...
int main(void)
{
    ...
    while (TRUE)
    {
        // Imprimir el cronometro en la coordenada (0, 0) de la pantalla.
				...
				glcd_xprintf(0, 0, BLANCO, NEGRO, FONT12X24, "Horas: %02u, Minutos: %02u, Segundos: %02u", horas, minutos, segundos); //los colores y el tamano vienen en glcd.h
...
int main(void)
{
    ...
    while (TRUE)
    {
        ...
        glcd_xprintf(0, 0, BLANCO, NEGRO, FONT12X24, "Pulse abajo para comenzar");
        ...
        tiempo_aleatorio = (rand() % 40001) + 1000;
        ...
        glcd_xprintf(0, 0, BLANCO, NEGRO, FONT12X24, "Tiempo de reaccion: %d", tiempo_reaccion);
